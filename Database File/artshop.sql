...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2026 at 09:35 AM
...
(1, 'NguyenTan', 'Dung', 'admin', 'admin@gmail.com', '4cb7a9e4b9acfd6d97a5aa9c1b83c3947a29c53f'),
...
CREATE TABLE `auction` (
  ...
  `status` enum('pending','approved','running','ended','paid','fraud') DEFAULT 'pending',
...
INSERT INTO `auction` (`auctionId`, `itemId`, `sellerId`, `minPrice`, `startTime`, `endTime`, `status`, `winnerId`, `createdAt`, `paymentDeadline`, `finalPrice`, `paidAt`) VALUES
(1, 59, 3, 10.00, '2026-05-20 16:00:36', '2026-05-20 16:11:23', '', NULL, '2026-05-20 09:00:36', NULL, NULL, NULL),
(2, 58, 3, 10.00, '2026-05-20 16:00:37', '2026-05-23 16:00:37', '', NULL, '2026-05-20 09:00:37', NULL, NULL, NULL),
(3, 8, 3, 10.00, '2026-05-20 16:00:37', '2026-05-23 16:00:37', '', NULL, '2026-05-20 09:00:37', NULL, NULL, NULL),
(5, 58, 3, 1000.00, '2026-05-20 18:17:00', '2026-05-20 18:20:00', '', NULL, '2026-05-20 11:18:01', NULL, NULL, NULL),
(7, 5, 2, 1000.00, '2026-05-22 16:58:00', '2026-05-22 18:00:00', 'approved', NULL, '2026-05-21 09:59:08', NULL, NULL, NULL),
(9, 8, 3, 1000.00, '2026-05-21 19:24:00', '2026-05-21 19:26:00', '', 3, '2026-05-21 12:24:25', '2026-05-21 20:26:03', 2000.00, NULL),
(10, 7, 2, 1000.00, '2026-05-21 20:04:00', '2026-05-21 20:06:00', 'ended', 3, '2026-05-21 13:04:33', '2026-05-21 21:06:02', 1001.00, NULL);
...
INSERT INTO `auction_requests` (`requestId`, `itemId`, `sellerId`, `status`, `createdAt`) VALUES
(1, 8, 3, 'approved', '2026-05-19 11:04:06'),
(2, 58, 3, 'approved', '2026-05-19 11:04:08'),
(3, 59, 3, 'approved', '2026-05-19 11:04:10'),
(4, 8, 3, 'approved', '2026-05-20 09:04:24'),
(5, 58, 3, 'approved', '2026-05-20 09:04:26'),
(6, 59, 3, 'approved', '2026-05-20 09:04:28'),
(7, 4, 2, 'approved', '2026-05-21 09:57:51'),
(8, 5, 2, 'approved', '2026-05-21 09:57:56'),
(9, 6, 2, 'approved', '2026-05-21 09:57:57'),
(10, 5, 2, 'pending', '2026-05-21 13:03:47'),
(11, 4, 2, 'pending', '2026-05-21 13:03:49'),
(12, 6, 2, 'pending', '2026-05-21 13:03:51'),
(13, 7, 2, 'approved', '2026-05-21 13:03:52');
...
INSERT INTO `bids` (`bidId`, `auctionId`, `buyerId`, `bidAmount`, `bidTime`) VALUES
(1, 4, 3, 2000.00, '2026-05-20 09:11:23'),
(2, 4, 3, 3000.00, '2026-05-20 09:21:21'),
(3, 4, 3, 5000.00, '2026-05-20 09:21:24'),
(4, 4, 6, 6000.00, '2026-05-20 09:23:04'),
(5, 4, 6, 7000.00, '2026-05-20 09:29:41'),
(6, 4, 6, 10000.00, '2026-05-21 09:34:58'),
(7, 2, 6, 1000.00, '2026-05-21 10:34:40'),
(8, 6, 6, 10000.00, '2026-05-21 10:48:34'),
(9, 3, 6, 1000.00, '2026-05-21 10:49:36'),
(10, 3, 6, 1002.00, '2026-05-21 11:31:38'),
(11, 2, 3, 1000.02, '2026-05-21 11:32:26'),
(12, 8, 3, 10000.00, '2026-05-21 12:19:04'),
(13, 9, 3, 2000.00, '2026-05-21 12:24:46'),
(14, 10, 3, 1001.00, '2026-05-21 13:05:02');
...
(3, 'testbuyer', '021f7c4a1d540d4f9f4f76dc9a36f23c977927cc', '2023-05-15', 'icloud14092003@gmai.com', 'Dung', 'Nguyen', 3, 0, 0, 0, 100000),
(6, 'testbuyer1', '2', '2023-05-16', 'testbuyer1@gmail.com', 'test', 'buyer', 6, 0, 0, 1, 99146),
(7, 'dung9a1lqd', 'e336f06c2090fdb09678fa34f2769ffeaf8992b4', '2026-04-18', 'dungxbeeboy@gmail.com', 'Dung', 'Nguyen', 7, 0, 0, 0, 100000);
...
--
-- Table structure for table `buyer_bid_limit`
--

CREATE TABLE `buyer_bid_limit` (
  `id` int(11) NOT NULL,
  `auctionId` int(11) NOT NULL,
  `buyerId` int(11) NOT NULL,
...
(104, 'WATER PAINTING', 22, 'water painting', 50),
(105, 'ACRYLIC PAINTING', 22, 'acrylic painting', 50),
(106, 'OIL PAINTING', 22, 'oil painting', 50);
...
(4, 'OPPO A16', '', '', 500, 123, '2025-05-15', 0, 0, 26, 2, NULL, NULL, 3, 123, '30', '04', 'Việt Nam'),
(5, 'VIVO V25', '', '', 300, 345, '2025-05-15', 0, 0, 29, 2, NULL, NULL, 2, 123, '30', '04', 'Việt Nam'),
(6, 'HWAWEI y9', '', '', 430, 123, '2025-05-15', 0, 0, 25, 2, NULL, NULL, 3, 123, '30', '04', 'Việt Nam'),
(7, 'FILA Men&#039;s MB', '', '', 340, 123, '2025-05-15', 0, 0, 56, 2, NULL, NULL, 2, 123, '30', '04', 'Việt Nam'),
(8, 'IPhone 14 ProMax', 'iPhone 14 Pro Max, với chip A16 và màn hình “viên thuốc” Dynamic Island', '', 1200, 144, '2025-05-15', 0, 1, 23, 3, NULL, NULL, 2, 144, 'Xuân Thủy', 'Cầu Giấy', 'Hà Nội'),
(9, 'New Balance 574', '', '', 66, 123, '2025-05-15', 0, 0, 52, 2, NULL, NULL, 20, 123, '30', '04', 'Việt Nam'),
(10, 'BABOLAT PURE STRIKE', '', '', 44, 23, '2025-05-15', 0, 0, 66, 2, NULL, NULL, 10, 12, '30', '04', 'Việt Nam'),
(11, 'MSI Modern 14', 'Trong tầm giá 16 triệu thì MSI Modern 14 204VN chính là lựa chọn tối ưu', '', 800, 65, '2025-05-15', 0, 0, 20, 4, NULL, NULL, 2, 2, 'Phạm Văn Đồng', 'Cầu Giấy', 'Hà Nội'),
(12, 'BLIZZARD TECNICA  4', '', '', 456, 12, '2025-05-15', 0, 0, 63, 2, NULL, NULL, 30, 123, '30', '04', 'Việt Nam'),
(13, 'fischer sports 12', '', '', 123, 12, '2025-05-15', 0, 0, 64, 2, NULL, NULL, 40, 12, '30', '04', 'Việt Nam'),
(14, 'BATA MEN', '', '', 44, 12, '2025-05-15', 0, 0, 57, 2, NULL, NULL, 10, 12, '30', '04', 'Việt Nam'),
(15, 'Salomon Mens', '', '', 66, 33, '2025-05-15', 0, 0, 61, 2, NULL, NULL, 20, 12, '30', '04', 'Việt Nam'),
(16, 'SamsungNP550XDA', 'Laptop Samsung NP550XDA Core i7-1165G7, 16gb Ram, 512gb SSD, vga rời nVidia MX450, 15,6inch Full HD , hàng nhập khẩu', '', 900, 45, '2025-05-15', 0, 0, 21, 4, NULL, NULL, 20, 22, 'Phạm Văn Đồng', 'Cầu Giấy', 'Việt Nam'),
(17, 'Uhlsport Radar 4', '', '', 53, 33, '2025-05-15', 0, 0, 67, 2, NULL, NULL, 12, 123, '30', '04', 'Việt Nam'),
(18, 'SamsungNote20Ultra5G', 'Galaxy Note 20 Ultra 5G, mẫu điện thoại flagship cao cấp thuộc dòng Note của Samsung, ra mắt tháng 8/2020 với diện mạo thay đổi cùng những nâng cấp đột phá', '', 1000, 43, '2025-05-15', 1, 1, 24, 3, NULL, NULL, 2, 5, 'Xuân Thủy', 'Cầu Giấy', 'Vietnam'),
(19, 'RADAR', '', '', 76, 789, '2025-05-15', 0, 0, 60, 2, NULL, NULL, 23, 123, '30', '04', 'Việt Nam'),
(20, 'Asus TUF Gaming', 'Laptop Asus TUF Gaming (HN188W) được trang bị bộ vi xử lý Intel mạnh mẽ, card đồ họa rời NVIDIA và ổ cứng SSD tốc độ cao, tất cả tạo nên một cỗ máy; mạnh mẽ, đáp ứng tốt nhu cầu chơi game ở mức độ cấu hình cao.', '', 1000, 30, '2025-05-15', 0, 0, 17, 4, NULL, NULL, 2, 34, 'p', 'Cầu Giấy', 'Việt Nam'),
(21, 'BURBERRY vintage', '', '', 33, 341, '2025-05-15', 0, 0, 58, 2, NULL, NULL, 12, 123, '30', '04', 'Việt Nam'),
(22, 'ATOMIC zen 3', '', '', 69, 234, '2025-05-15', 0, 0, 65, 2, NULL, NULL, 39, 23, '30', '04', 'Việt Nam'),
(23, 'HP 15-DY2795', 'Laptop HP 15 Core i5 1135G7 RAM 8GB SSD 256GB 15.6&#039;&#039; FHD', '', 700, 56, '2025-05-15', 0, 0, 14, 4, NULL, NULL, 0, 21, 'p', 'Cầu Giấy', 'Việt Nam'),
(24, 'VALORANT CVY', '', '', 34, 121, '2025-05-15', 0, 0, 39, 2, NULL, NULL, 22, 23, '30', '04', 'Việt Nam'),
(25, 'LG Gram 17 2021', 'Laptop LG Gram 17 2021 i7 (17Z90P-G.AH76A5) là 1 phiên bản laptop thời trang mang thiết kế siêu mỏng nhẹ với cấu hình mạnh mẽ, giải trí đẳng cấp, là 1 lựa chọn đầy thú vị dành cho bạn.', '', 950, 45, '2025-05-15', 0, 0, 19, 4, NULL, NULL, 3, 3, 'P', 'Cầu Giấy', 'Việt Nam'),
(26, 'MI 10', '', '', 99, 1234, '2025-05-15', 0, 0, 27, 2, NULL, NULL, 23, 12, '30', '04', 'Việt Nam'),
(27, 'SKECHERS 11', '', '', 77, 234, '2025-05-15', 0, 0, 55, 2, NULL, NULL, 33, 123, '30', '04', 'Việt Nam'),
(28, 'PUMA 42', '', '', 234, 234, '2025-05-15', 0, 0, 54, 2, NULL, NULL, 35, 234, '30', '04', 'Việt Nam'),
...
--
-- Indexes for table `auction_requests`
--
...
--
-- Indexes for table `buyer_bid_limit`
--
ALTER TABLE `buyer_bid_limit`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `auction`
  MODIFY `auctionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `auction_requests`
--
ALTER TABLE `auction_requests`
...
--
ALTER TABLE `bids`
  MODIFY `bidId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- AUTO_INCREMENT for table `buyer_bid_limit`
--
ALTER TABLE `buyer_bid_limit`
...
--
ALTER TABLE `childcategory`
  MODIFY `childcategoryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
